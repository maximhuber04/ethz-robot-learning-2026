...
class SACAgent:
    ...
    def sample_action(self, obs: torch.Tensor):
        ...
        """
        with torch.no_grad():
            # DONE: Sample an action from the actor for environment interaction.
            #
            # Hint:
    ...
    def compute_critic_loss(self, obs, act, rew, next_obs, done) -> torch.Tensor:
        ...
        """
        with torch.no_grad():
            # DONE: Compute the target Q value for SAC.
            #
            # Hint:
            ...
            q_next = torch.minimum(q1_next, q2_next) - self.alpha * next_logp
    ...
    def compute_actor_loss(self, obs, act_new, logp_new) -> torch.Tensor:
        ...
        """
        # DONE: Compute the SAC actor loss.
        #
        # Hint:
    ...
    def compute_alpha_loss(self, logp_new) -> torch.Tensor:
        ...
        """
        # DONE: Compute the SAC temperature loss.
        #
        # Hint:
    ...
    def soft_update_targets(self) -> None:
        ...
        """
        # DONE: Soft-update the target critic parameters.
        #
        # Hint:
    ...
    def update(self, batch: ReplayBatch) -> SACUpdateStats:
        ...
        # DONE: Complete one SAC update step.
        #
        # Hint:
        ...
        # DONE: Soft-update the target critics
